package com.attendance.attendance_api.config;

import com.attendance.attendance_api.security.JwtAuthFilter;
...
@Configuration // "this class produces beans Spring should manage" — think of @Bean methods as a factory
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // hashes passwords, never store plaintext, ever
    }
